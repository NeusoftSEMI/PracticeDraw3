...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.e("gadgasdg", (rect1.bottom + rect1.top) / 2 + "||" + rect1.bottom + "||" + rect1.top);
        canvas.drawText(text1, 100, middle - (rect1.bottom + rect1.top) / 2, paint2);
        canvas.drawText(text2, 200, middle - (rect2.bottom + rect2.top) / 2, paint2);
        canvas.drawText(text3, 300, middle - (rect3.bottom + rect3.top) / 2, paint2);
        canvas.drawText(text4, 400, middle - (rect4.bottom + rect4.top) / 2, paint2);
        canvas.drawText(text5, 500, middle - (rect5.bottom + rect5.top) / 2, paint2);
        canvas.drawText(text6, 600, middle - (rect6.bottom + rect6.top) / 2, paint2);
    }
}